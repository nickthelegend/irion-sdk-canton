...
function PayWithXorr({ checkoutUrl, createCheckout, onSuccess, onError, className, style, children }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("button", { type: "button", onClick: handleClick, disabled: loading, className, style, children: children ?? (loading ? "Opening XORR\u2026" : "Buy Now, Pay Never \u2014 with XORR") });
}
